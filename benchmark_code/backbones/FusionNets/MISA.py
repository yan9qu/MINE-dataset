...
class MISA(nn.Module):
    ...
    def forward(self, text_feats, video_feats, audio_feats):
        ...
        # text_feats = torch.randn((16, 768)).cuda()
        # video_feats = torch.randn((16, 1024)).cuda()
        # audio_feats = torch.randn((16, 60, 768)).cuda()
        ...
        # lengths is a list of length of each sentence in the batch, set to (batch_size,20) for now
